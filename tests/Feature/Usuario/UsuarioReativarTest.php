...
class UsuarioReativarTest extends TestCase
{
    use DatabaseTransactions;

    public function test_reativarUsuario_without_beingAuthenticated_returnsUnauthorized(): void
    {
        // Arrange
        $data = [
        ...
        // Act
        $response = $this->putJson('/api/usuario/reativar', $data);
        $responseBody = json_decode($response->getContent(), true);
        // Assert
        $response->assertUnauthorized();
    }
    public function test_reativarUsuario_with_beingAuthenticated_butWithoutPermission_returnsForbidden(): void
    {
        // Arrange
        User::truncate();
    ...
    public function test_reativarUsuario_with_duplicate_usuarios_returnsBadRequest(): void
    {
        // Arrange
        User::truncate();
        Perfil::truncate();
    ...
    public function test_reativarUsuario_with_inexisting_usuarios_returnsNotFound(): void
    {
        // Arrange
        User::truncate();
        Perfil::truncate();
    ...
    public function test_reativarUsuario_with_validData_returnsOk(): void
    {
         // Arrange
        User::truncate();
        Perfil::truncate();
        ...
        // Assert
        $response->assertOk();
        $this->assertEquals('Usuarios reativados com sucesso!', $responseBody['message']);
